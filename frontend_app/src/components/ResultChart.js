...
const renderCustomAxisTick = ({ x, y, payload }) => {
  ...
  switch (payload.value) {
    case 'angry':
        imageSrc = 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/google/263/angry-face_1f620.png';
        break;
    case 'happy':
        imageSrc = 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/google/263/grinning-face_1f600.png';
        break;
    case 'sad':
        imageSrc = 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/google/263/sad-but-relieved-face_1f625.png';
        break;
    case 'relaxed':
        imageSrc = 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/google/263/relieved-face_1f60c.png';
        break;
    default:
        imageSrc = '';
  }
...
export default function ResultChart() {
  ...
  return (
    ...
    <ResponsiveContainer>
        <BarChart data={stateResults} margin={{top: 16, right: 8, bottom: 82, left: 0}}>
